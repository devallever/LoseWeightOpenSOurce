...
public class ProgressWeekView extends WeekView {
    ...
    private Paint mFuturePaint = new Paint();
    private int mRadius;
    ...
    public ProgressWeekView(Context context) {
        ...
        mProgressPaint.setColor(0xBB16b070);
        ...
        //还未到的日期
        mFuturePaint.setAntiAlias(true);
        mFuturePaint.setStyle(Paint.Style.STROKE);
        mFuturePaint.setStrokeWidth(dipToPx(context, 2.2f));
        mFuturePaint.setColor(Color.parseColor("#d0d0d0"));
    }
