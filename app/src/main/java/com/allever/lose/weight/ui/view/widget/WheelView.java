...
//                canvas.drawLine(viewWidth * 1 / 6, obtainSelectedAreaBorder()[1], viewWidth * 5 / 6, obtainSelectedAreaBorder()[1], paint);
                canvas.drawLine(viewWidth / 2 - dip2px(40), obtainSelectedAreaBorder()[0], viewWidth / 2 + dip2px(40), obtainSelectedAreaBorder()[0], paint);
                canvas.drawLine(viewWidth / 2 - dip2px(40), obtainSelectedAreaBorder()[1], viewWidth / 2 + dip2px(40), obtainSelectedAreaBorder()[1], paint);
            }
